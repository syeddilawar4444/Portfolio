...
import Cv from "../assets/Syed Dilawar Hussain CV.pdf"
        ...
        <div className="container mx-auto h-full">
          <div className="flex items-center h-full pt-8">
            ...
            <div className="flex-1 flex flex-col items-center lg:items-start">
              <p className=' text-gray-400 mb-6 text-4xl text-center md:text-5xl font-script '>Hey, I'm Syed Dilawar Hussain</p>
